...
import { ConfiguratorProps, FileComponentDefinition } from '../../types';
...
export function Configurator({ formData, onUpdateFormData }: ConfiguratorProps) {
    const fileData = formData as FileComponentDefinition;
                    ...
                    {Object.entries(FILE_TYPE_PRESETS).map(([key, preset]) => (
                        <button
                            ...
                            className={cn(
                                ...
                                JSON.stringify(fileData.accept || []) === JSON.stringify(preset.extensions)
